...
export const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    tech: ["React.js", "HTML", "Tailwind CSS", "Github Actions"],
  ...
  },
  {
    ...
    description:
      "Website that uses historical Citibike data to show status of the nearest Citibike stations, along with availability data from the past week.",
